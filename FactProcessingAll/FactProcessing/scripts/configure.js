...
console.log("AccountId: " + accountId + " bucketName: " + bucketName + " functionName: " + functionName + " region: " + region);
...
if (functionName == 'AwsServerlessExpressFunction') {
  console.error('Still has default function anem')
  process.exit(1);
}
